...
#이미__붙어있어 별도로 접근권한을 건드릴수 없다
# 편법을 써야한다. 데이터말고 일을하는 클래스들을 만들때 좋다.
# 쓸데없이 객체가 만들어졌다 없어졌다 하는걸 방지할수 있다.
#  
s2 = Singleton()
s2.display()
